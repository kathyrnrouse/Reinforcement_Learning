...
sys.path.append(os.path.join('/Users/krouse/Documents/CUIP/deepq_example/sumo-1.3.1/', 'tools'))
#sys.path.append(os.path.join('/Users/krouse/Documents/CUIP/deepq_example/sumo-1.3.1/', 'tools/contributed/traci4matlab'))
import traci
...
#sumoBinary = "/Users/krouse/Documents/CUIP/RL/double-dueling-dqn/sumo-1.3.1"
#sumoCmd = [sumoBinary, "-c", "./tools/game/cross.sumocfg"]  #The path to the sumo.cfg file
sumoCmd = [sumoBinary, "-c", "/Users/krouse/Documents/CUIP/deepq_example/sumo-1.3.1/tools/game/cross.sumocfg"]  #The path to the sumo.cfg file
